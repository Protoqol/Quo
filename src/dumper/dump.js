Sfdump = window.Sfdump || (function
    (doc) {
    var refStyle = doc.createElement('style'), rxEsc = /([.*+?^${}()|\[\]\/\\])/g, idRx = /\bquo-dump-\d+-ref[012]\w+\b/,
    ...
    function resetHighlightedNodes(root) {
        Array.from(root.querySelectorAll('.quo-dump-str, .quo-dump-key, .quo-dump-public, .quo-dump-protected, .quo-dump-private')).forEach(function (strNode) {
